...
namespace smt::noodler {
    ...
    protected:
        ...
        std::vector<std::tuple<unsigned, unsigned,expr_ref_vector ,expr_ref_vector> > lyndon_pairs;
    ...
    protected:
        ...
        */
        ...
        void check_lyndon(const expr_ref& left_side,const expr_ref& right_side);
        // std::vector<size_t> prefix_function(const expr_ref_vector& vec);
        // std::pair<expr_ref,expr_ref> simplify_eq(const expr_ref& left_side,const expr_ref& right_side);
        /**
